...
header = ["e","n"]
T = pd.read_csv("mammalia/p2p-Gnutella06.mtx",sep=" ", header = None, names=header)

Graph = nx.from_pandas_edgelist(T, "e", "n")
nx.draw(Graph)
plt.show()
...
if (connected):
    print('The diameter is',nx.diameter(Graph))
else:
